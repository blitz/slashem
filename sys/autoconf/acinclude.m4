...
dnl  NETHACK_PROG_CC_FOR_BUILD_WORKS(cc/cflags[,[action-if-good][,action-if-bad]])
dnl  -----------------------------------------------------------------------------
...
AC_DEFUN([NETHACK_PROG_CC_FOR_BUILD_WORKS],
...
EOF
nethack_compile="$1 conftest.c"
cc_for_build_works=no
if AC_TRY_EVAL(nethack_compile); then
